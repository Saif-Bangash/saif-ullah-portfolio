    ...
    <div className="bg-white dark:bg-[#0a0118] transition-colors duration-500">
      ...
      >
        ...
        <div className="text-center lg:text-left mb-10">
          <h4 className="text-[#D9A93E] font-bold uppercase tracking-[0.3em] text-xs md:text-sm">
            My Work
          </h4>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="relative group w-full lg:flex-1">
            <div className="absolute -inset-4 bg-[#D9A93E]/20 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <div className="w-full lg:flex-1 space-y-4 text-center lg:text-left">
            <span className="text-[#D9A93E] text-xs font-bold uppercase tracking-widest">
              Featured Project
            </span>
            ...
            <div className="pt-6 flex justify-center lg:justify-start">
              <a
                ...
                className="group flex items-center gap-2 text-gray-900 dark:text-white font-semibold text-sm hover:text-[#D9A93E] dark:hover:text-[#D9A93E] transition-colors"
              >
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 md:gap-12">
          ...
          <div className="w-full lg:flex-1 space-y-4 text-center lg:text-left">
            ...
            <div className="pt-6 flex justify-center lg:justify-start">
              ...
              text-gray-900 dark:text-white hover:text-[#D9A93E] dark:hover:text-[#D9A93E] transition-colors"
              >
                <span>View Live Project</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
