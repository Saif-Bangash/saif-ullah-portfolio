...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative w-full bg-white dark:bg-[#0a0118] min-h-screen flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-20 py-20 lg:py-25 overflow-hidden transition-colors duration-500"
    >
      ...
      <div className="w-full lg:w-3/5 flex flex-col gap-4 md:gap-6 z-10 text-center lg:text-left items-center lg:items-start">
        ...
        >
          <span className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl">
            Hi, I'm{" "}
          </span>
          <span className="text-[#5C4DFF] whitespace-nowrap">
            Saif_ullah Bangash
          </span>
          <br />

          <span className="font-serif italic text-gray-400 dark:text-gray-500 text-3xl md:text-5xl xl:text-5xl font-normal">
        ...
        <div className="flex gap-6 mt-6 text-gray-400 dark:text-gray-500 text-2xl justify-center lg:justify-start">
          <FaHtml5
            title="HTML5"
            className="text-[#E34F26] transition-colors"
          />
          ...
          <FaReact
            title="React"
            className="text-[#61DBFB] transition-colors"
          />
      ...
      <div className="w-full lg:w-2/5 relative mt-16 lg:mt-0 flex justify-center z-10">
        <div className="relative">
          ...
          >
            <p className="text-lg sm:text-2xl font-bold text-blue-500">10+</p>
            <p className="text-[8px] sm:text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-extrabold">
